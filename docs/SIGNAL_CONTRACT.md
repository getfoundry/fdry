...
**Status:** v0.1 draft
**Owners:** fdry/bot consumer, unify/fib-harness producer
...
**Path (to be created):**
`/Users/lekt9/Projects/unify/.fib-harness-v2.4/jesus_loop_weights_emit.py`

**Responsibility:** After each successful nightly fib-harness run, read the
...
**Path:** `/Users/lekt9/Projects/fdry/runs/daily_signal/YYYY-MM-DD.json`
...
```
file = latest("/Users/lekt9/Projects/fdry/runs/daily_signal/*.json")
...
Target: `/Users/lekt9/Projects/unify/.fib-harness-v2.4/jesus_loop_weights_emit.py`

```python
#!/usr/bin/env python3
"""Emit daily signal JSON from the fib-harness top-k configs. Fail-closed."""
import json, os, tempfile, datetime as dt
from pathlib import Path

UNIVERSE = ["SOL","WIF","JTO","BONK","PYTH","JUP","ORCA","RAY"]
OUT_DIR  = Path("/Users/lekt9/Projects/fdry/runs/daily_signal")
